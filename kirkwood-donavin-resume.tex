...
\begin{position}
	...
	\begin{itemize}
		...
		\item \textbf{Analytics Infrastructure:} Leveraged SQL fluency across multiple database implementations (Presto, BigQuery, Python/sqlalchemy) and reporting platforms (LookML, MicroStrategy) to deliver decision-support dashboards tracking conversion, CTR, and friction metrics; managed my team's git repo of SQL scripts
	\end{itemize}
\end{position}
